...
for i in range(data.shape[0]):
  ...
  print(data.iloc[[i]].index[0], predict)
  ...
  pred_file.loc[data.iloc[[i]].index[0], all_cols] = data.iloc[[i]].values
  # pred_file.loc[D, all_cols] = data.iloc[[i]].values
  pred_file.loc[data.iloc[[i]].index[0] + timedelta(hours=6), 'pred6h'] = predict
